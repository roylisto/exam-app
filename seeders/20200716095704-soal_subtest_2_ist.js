...
module.exports = {
  up: (queryInterface, Sequelize) => {
    const subtest_2_pilgan = [
      ...
      '{"a":"jarak","b":"perpisahan","c":"tugas","d":"batas","e":"perceraian"}', '{"a":"saringan","b":"kelambu","c":"payung","d":"tapisan","e":"jala"}', '{"a":"putih","b":"pucat","c":"buram","d":"kasar","e":"berkilauan"}', '{"a":"otobis","b":"pesawat terbang","c":"sepeda motor","d":"sepeda","e":"kapal api"}', '{"a":"biola","b":"seruling","c":"klarinet","d":"terompet","e":"saxophon"}', '{"a":"bergelombang","b":"kasar","c":"berduri","d":"licin","e":"lurus"}', '{"a":"jam","b":"kompas","c":"penunjuk jalan","d":"bintang pari","e":"arah"}', '{"a":"kebijakasanaan","b":"pendidikan","c":"perencanaan","d":"penempatan","e":"pengerahan"}', '{"a":"bermotor","b":"berjalan","c":"berlayar","d":"bersepeda","e":"berkuda"}', '{"a":"gambar","b":"lukisan","c":"potret","d":"patung","e":"ukiran"}', '{"a":"panjang","b":"lonjong","c":"runcing","d":"bulat","e":"bersudut"}', '{"a":"kunci","b":"palang pintu","c":"gerendel","d":"gunting","e":"obeng"}', '{"a":"jembatan ","b":"batas ","c":"perkawinan","d":"pagar","e":"masyarakat"}', '{"a":"mengetam","b":"memahat","c":"mengasah","d":"melicinkan","e":"menggosok"}', '{"a":"batu","b":"baja","c":"bulu","d":"karet","e":"kayu"}'
    ];
